...
public class ProductTest {
	...
	void createProductTest() {
		Products products = new Products(1, "IPhone", "Apple", 100000, 20);
	...
	void getAllProductTest() {
		Products products = new Products(1, "mobile", "Apple", 100000, 20);
		Products products1 = new Products(1, "Laptop", "HP", 100000, 20);
